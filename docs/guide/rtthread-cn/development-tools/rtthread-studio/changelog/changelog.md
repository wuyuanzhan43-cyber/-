# 更新日志
##### [V2.3.1更新发布](https://club.rt-thread.org/ask/article/33e6c379c1ae78fb.html)

- 更新内置 env 最新版本为 2.1.0
- 更新适配先楫最新程序下载命令参数
- 优化完善 RT-Thread Settings 功能
- 优化 Run to main 调试断点功能
- 优化工程创建，添加高版本内核 examples 兼容
- 优化 GDH7 芯片 JLink 下载速率默认值为 4 MHz
- 解决 SDK Manager 访问官网证书过期的问题
- 解决雅特力芯片支持包创建项目时强制 J-LINK 要选择 6.80d 版本的问题
- 解决 GDH7 用 J-LINK 调试时暂停后再全速时程序直接跑飞的问题
- 解决软件包 packages 库无法同步更新的问题
- 解决双击打开 Renesas RA Settings 没反应的问题并优化 rasc 程序选择方式
- 解决 SDK Manger 内 RT-Thread latest 版本下载和更新失败的问题
- 解决切换 workspace 后，关闭 studio 再打开又自动切回默认 workspace 的问题
- 解决安装软件包后重启 studio 偶尔提示工程损坏的问题

##### [V2.3.0更新发布](https://club.rt-thread.org/ask/article/96166f7ee04d9bf5.html)

- 新增支持针对 rt-thread 版本号大于 5.1.0 时使用 Env2.0.0 高版本
- 新增支持卸载 studio 时选择是否保留已下载的 SDK 资源包文件
- 修复 SDK 管理器选择了版本号过滤后再点刷新按钮后版本号过滤失效的问题
- 修复 lds 编辑器打开报错的问题
- 完善创建基于芯片工程时为不同RTT内核版本的 API(weak、align) 做兼容
- 优化切换 workspace 时默认不启用黑色主题界面
- 修复 RA Smart Configurator 打开异常的问题

##### [V2.2.9更新发布](https://club.rt-thread.org/ask/article/b90cccddcc636f8f.html)

- 修复 Restart 调试按钮不显示的问题
- 修复双击 CubeMx/RA Configuration 重复打开的问题
- 修复切换 workspace 后快捷键失效的问题
- 修复解析 ld/lds 链接脚本文件失败问题
- 修复双击 ld/lds 链接脚本文件重复弹框问题
- 修复调试配置界面调试器程序设置失效问题
- 优化 SDK Manager 工具栏按钮在黑色主题下的显示问题
- 优化软件异常提示信息


##### [V2.2.8更新发布](https://club.rt-thread.org/ask/article/19c3df7154078bf3.html)

- 新增 SDK 管理器支持离线导入 RT-Thread 源码包等其他资源包
- 解决 md 文件中嵌入 md 文件打不开问题
- 解决构建配置界面打开报错问题
- 解决同名工程调试配置缓存异常问题
- 解决切换 workspace 导致快捷键和变量失效问题
- 解决 SVD 文件解析异常问题
- 解决 SDK 管理器离线导入资源包未安装依赖问题
- 解决 RTT_EXEC_PATH 指向工具链路径不正确问题
- 解决先楫工程创建后工程名被改为 project 问题
- 完善链接脚本编辑器，格式不兼容时默认文本编辑器打开
- 完善汉化调试配置界面
- 优化设置将源码目录显示在工程节点最上面
- 优化先楫的调试器名称将 FT2232 修改为 OpnOCD

##### [V2.2.7更新发布](https://club.rt-thread.org/ask/article/dcf3a2c41ec79cd3.html)

- 新增 svd 文件配置支持 xml 的选择
- 新增链接脚本对 ld 后缀名识别支持
- 解决 HPMicro 开发板的 OpenOCD 调试异常问题
- 解决工程的工具链配置路径查找异常问题
- 解决软件包和主仓同步更新的问题
- 完善工程右键打开 Env 时设置 RTT_EXEC_PATH 变量为当前工程工具链路径
