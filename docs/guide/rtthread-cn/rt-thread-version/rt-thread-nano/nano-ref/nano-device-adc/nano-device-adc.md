...
1. 在 RT-Thread 标准版中，[ADC 设备](../../../rt-thread-standard/programming-manual/device/adc/adc_v1/adc.md) 驱动提供了一套设备管理接口来访问 ADC，用户程序可以直接使用该 API 操作 ADC 的功能，设备管理接口如下：
...
3. 我们需要适配如上 4 个 ADC 设备 API，参考实例：[drv_adc.c](https://gitee.com/rtthread/docs-online/tree/master/rt-thread-version/rt-thread-nano/nano-ref/nano-device-adc/demo_code/drv_adc.c) 和 [drv_adc.h](https://gitee.com/rtthread/docs-online/tree/master/rt-thread-version/rt-thread-nano/nano-ref/nano-device-adc/demo_code/drv_adc.h)。
