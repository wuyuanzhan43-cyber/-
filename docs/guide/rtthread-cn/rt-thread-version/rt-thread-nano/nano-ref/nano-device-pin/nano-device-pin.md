...
3. 我们需要适配如上 7 个 PIN 设备 API ，参考实例：[drv_gpio.c](https://gitee.com/rtthread/docs-online/tree/master/rt-thread-version/rt-thread-nano/nano-ref/nano-device-pin/demo_code/drv_gpio.c) 和 [drv_gpio.h](https://gitee.com/rtthread/docs-online/tree/master/rt-thread-version/rt-thread-nano/nano-ref/nano-device-pin/demo_code/drv_gpio.h)。
